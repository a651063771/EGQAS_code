...
record = wfdb.rdrecord('./mitdb/100', sampfrom=0,sampto=650000, physical=False, channels=[0, ])
...
signal_annotation = wfdb.rdann('./mitdb/100', "atr",summarize_labels=True,sampfrom=0,sampto=650000)
